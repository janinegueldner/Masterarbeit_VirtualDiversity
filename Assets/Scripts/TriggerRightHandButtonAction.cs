...
public class TriggerRightHandButtonAction : MonoBehaviour
{
    ...
    void Update()
    {
        if (!devicesInitialized)
        {
            ...
            if (devices.Count == 0)
            {
                Debug.LogWarning("No right-handed devices found. Retrying...");
            ...
            else
            {
                ...
                {
                    Debug.Log("Right-handed device found: " + device.name);
